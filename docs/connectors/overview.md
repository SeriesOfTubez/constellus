...
|---|---|---|
| **Discovery** | Find domains and subdomains | Cloudflare, Shodan (passive domain index) |
| **Port discovery** | Probe IP assets for open TCP ports | Naabu |
| **Enrichment** | Add context to discovered assets | Tenable, Wiz, FortiManager, Shodan |
...
|---|---|---|
| Certificate Transparency | Passive | Queries SSLMate's Certspotter for historical SSL certs across the major CT logs |
