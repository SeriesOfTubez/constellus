...
class WizConnector(EnrichmentConnector):
    ...
    def enrich(self, assets: list[DiscoveredAsset], config: dict[str, Any]) -> PhaseResult:
        ...
        """
        from app.connectors.http import connector_post  # noqa: F401
        ...
        # Pattern:
        #   1. connector_post("/oauth/token") → get bearer token
        #   2. connector_post(api_endpoint, json={"query": graphql_query})
